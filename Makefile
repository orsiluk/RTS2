...
OBJECTS=Objects/RelayDHCP.o Objects/Announce.o Objects/ARP.o Objects/Delay.o \
   Objects/DHCP.o Objects/DNS.o Objects/DHCPs.o Objects/ETH97J60.o  \
...
Objects/RelayDHCP.o : RelayDHCP.c $(SDCC_HEADERS)  \
   $(SDCC_PIC16_HEADERS) $(APP_HEADERS) $(TCPIP_HEADERS)
	$(CC) -c -mpic16 -p18f97j60  -o"Objects/RelayDHCP.o" -L/usr/local/lib/pic16  RelayDHCP.c
